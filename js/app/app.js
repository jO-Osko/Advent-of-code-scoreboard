...
var $author$project$App$GotJson = function (a) {
	return {$: 'GotJson', a: a};
};
var $author$project$Models$User = F8(
	function (name, surname, githubLink, githubRepoLink, aocId, bestPoints, confirmedSolutionPoints, dayResults) {
		return {aocId: aocId, bestPoints: bestPoints, confirmedSolutionPoints: confirmedSolutionPoints, dayResults: dayResults, githubLink: githubLink, githubRepoLink: githubRepoLink, name: name, surname: surname};
	});
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $author$project$Models$AssigmentPoint = function (a) {
	return {$: 'AssigmentPoint', a: a};
};
var $author$project$Models$assigment_plus = F2(
	function (_v0, _v1) {
		var p1 = _v0.a;
		var p2 = _v1.a;
...
var $author$project$Models$IntermediateDayResult = F4(
	function (language, solutionConfirmed, solved, solvedTime) {
		return {language: language, solutionConfirmed: solutionConfirmed, solved: solved, solvedTime: solvedTime};
	});
...
var $author$project$App$decodeDayResult = A4(
	...
	A3(
		...
		A3(
			...
			A4(
				...
				$elm$core$Maybe$Nothing,
				$elm$json$Json$Decode$succeed($author$project$Models$IntermediateDayResult)))));
...
var $author$project$Models$score = function (assigmentResult) {
	var _v0 = function () {
		var _v1 = assigmentResult.solved;
		if (!_v1) {
	...
	var confirmedSolutionPoints = _v0.b;
	return {assigmentResult: assigmentResult, bestPoints: bestPoints, confirmedSolutionPoints: confirmedSolutionPoints};
};
var $author$project$Models$scoreInfo = F2(
	function (sA1, sA2) {
		var _v0 = _Utils_Tuple2(sA1, sA2);
		if (_v0.a.$ === 'Nothing') {
			if (_v0.b.$ === 'Nothing') {
				var _v1 = _v0.a;
				var _v2 = _v0.b;
				...
				var _v4 = _v0.a;
				var s2 = _v0.b.a;
				return _Utils_Tuple2(s2.confirmedSolutionPoints, s2.bestPoints);
			}
		} else {
			if (_v0.b.$ === 'Nothing') {
				var s1 = _v0.a.a;
				var _v3 = _v0.b;
				return _Utils_Tuple2(s1.confirmedSolutionPoints, s1.bestPoints);
			} else {
				var s1 = _v0.a.a;
				var s2 = _v0.b.a;
				return _Utils_Tuple2(
					A2($author$project$Models$assigment_plus, s1.confirmedSolutionPoints, s2.confirmedSolutionPoints),
					A2($author$project$Models$assigment_plus, s1.bestPoints, s2.bestPoints));
			}
		}
	});
var $author$project$App$decodeNekej = A2(
	$elm$json$Json$Decode$andThen,
	function (dict) {
		var day2 = A2(
			$elm$core$Maybe$map,
			A2($elm$core$Basics$composeR, $author$project$Models$assigmentFromIntermediate, $author$project$Models$score),
			A2($elm$core$Dict$get, '2', dict));
		var day1 = A2(
			$elm$core$Maybe$map,
			A2($elm$core$Basics$composeR, $author$project$Models$assigmentFromIntermediate, $author$project$Models$score),
			A2($elm$core$Dict$get, '1', dict));
		var _v0 = A2($author$project$Models$scoreInfo, day1, day2);
		var confirmed = _v0.a;
		var best = _v0.b;
		return $elm$json$Json$Decode$succeed(
			{bestPoints: best, confirmedSolutionPoints: confirmed, day: 0, star1: day1, star2: day2});
	},
	$elm$json$Json$Decode$dict($author$project$App$decodeDayResult));
var $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$hardcoded = A2($elm$core$Basics$composeR, $elm$json$Json$Decode$succeed, $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom);
var $author$project$Models$invalidPoints = $author$project$Models$AssigmentPoint(-1);
var $author$project$App$decodeUser = A2(
	$elm$json$Json$Decode$andThen,
	function (usr) {
		var sumSome = function (getter) {
			return A3(
				$elm$core$List$foldl,
				$author$project$Models$assigment_plus,
				$author$project$Models$zeroPoints,
				A2(
					$elm$core$List$map,
					getter,
					$elm$core$Dict$values(usr.dayResults)));
		};
		var confirmedSolutionPoints = sumSome(
			function ($) {
				return $.confirmedSolutionPoints;
			});
		var bestPoints = sumSome(
			function ($) {
				return $.bestPoints;
			});
		return $elm$json$Json$Decode$succeed(
			_Utils_update(
				usr,
				{bestPoints: bestPoints, confirmedSolutionPoints: confirmedSolutionPoints}));
	},
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'solution_data',
		A2(
			...
			$elm$json$Json$Decode$dict($author$project$App$decodeNekej)),
		A2(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$hardcoded,
			$author$project$Models$invalidPoints,
			A2(
				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$hardcoded,
				$author$project$Models$invalidPoints,
				A4(
						...
						A4(
							...
							A3(
								...
								A3(
									...
									'name',
									$elm$json$Json$Decode$string,
									$elm$json$Json$Decode$succeed($author$project$Models$User))))))))));
var $author$project$App$dataDecoder = $elm$json$Json$Decode$list($author$project$App$decodeUser);
...
var $author$project$App$initData = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$App$GotJson, $author$project$App$dataDecoder),
...
var $author$project$Models$showAssigmentPoint = function (_v0) {
	...
	return $elm$core$String$fromFloat(
		A2($elm$core$Basics$min, p / $author$project$Models$pointMultiplier, $author$project$Models$maxPoints)) + ' Točk';
};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Preverjene točke')
								]))
						]))
				]),
			A2(
...
var $author$project$App$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
				$author$project$Models$initialModel,
				$elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[$author$project$App$initData])));
		},
